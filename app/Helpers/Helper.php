...
public static function StringRepair($temptext)
{
...
public static function StringRepair3($temptext)
{
    $temptext=trim($temptext);
    $temptext=str_replace("&#39;","'",$temptext);
    $temptext=str_replace("&#34;","\"",$temptext);
...
public static function PageConfig($baseurl,$total_records,$limit_per_page,$uriseg){
    $config = array();
...
public static function Actdeact($act){
    $btnval = "";
    if($act == 1):
...
public static function manageheader($managePage,$addPage,$addButton,$icon='',$exportPage="",$exportButton=""){
    $action="";
    if($icon==''){
        $icon="plus";
    }
...
public static function noRecord($addPage=''){
...
public static function labelbox($colname,$label,$value){
...
public static function editbox($colname,$label,$fieldname,$placeholder,$value,$script=""){
...
public static function numberbox($colname,$label,$fieldname,$placeholder,$value,$script=""){
    $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function textareabox($colname,$label,$fieldname,$placeholder,$value,$script=''){
    $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function emailbox($colname,$label,$fieldname,$placeholder,$value,$script=""){
    $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function passwordbox($colname,$label,$fieldname,$placeholder,$value,$script=""){
   $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function dropdownbox($colname,$label,$fieldname,$array,$value,$script=""){
    $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function multidropdownbox($colname,$label,$fieldname,$array,$value,$script=""){
    $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function datepicker($colname,$label,$fieldname,$placeholder,$value,$script=""){
       $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function timepicker($colname,$label,$fieldname,$placeholder,$value,$script=""){
        $isrequired=strpos($script,"required");
    if(is_numeric($isrequired))
    {
        $label.=" <b class='text-danger'>*</b>";
...
public static function daterangepicker($colname,$label,$fieldname,$placeholder,$value,$script=""){
        echo '<div class="col-md-'.$colname.'">
                            <fieldset class="form-group">
                                <label class="form-label">'.$label.'</label>
                                <div class="input-group date ">
...
public static function checkbox($check,$label,$fieldname){
    $checked = "";
    if($check == 1){
        $checked = "checked";
    }
...
public static function uploadbox($colname,$label,$fieldname,$placeholder){
...
public static function submitbutton($pageBack,$iseditable=0){
    $disabled='';
    if($iseditable)
    $disabled='disabled';
...
public static function datalistbox($array,$id)
{
...
public static function customData($arraydata,$cid){
    ...
    foreach($arraydata as $column => $value)
    {
       ...
       public static function set_menu_item($menu)
       {
...
public static function form_divider($label){
...
public static function get_total_hour($arr)
{
  $result = 0;
...
public static function custom_amount_formatter($amount)
{
